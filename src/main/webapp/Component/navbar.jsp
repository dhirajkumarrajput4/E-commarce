    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" data-toggle="modal" data-target="#cart"><i class="fa fa-cart-plus" style="font-size: 30px;"></i> <span class="cart-items" style="font-size: 20px; color:aqua; margin-right: 3px;"> ( 0 ) </span></a>
                </li>
                <%                    if (user1 == null) {
                %>
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="logoutServlate">Logout</a>
                </li>
